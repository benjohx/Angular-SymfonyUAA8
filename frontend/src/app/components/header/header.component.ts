    ...
    <header class="header">
      <div class="container">
        ...
        <nav class="nav">
          ...
          <a routerLink="/properties" class="nav-link" routerLinkActive="active">Properties</a>
          <a *ngIf="(currentUser$ | async)?.roles?.includes('ROLE_ADMIN')" routerLink="/add-property" class="nav-link" routerLinkActive="active">Add Property</a>
        ...
        <div class="user-section">
          ...
          <ng-template #loginSection>
            ...
            <button class="btn btn-outline" (click)="navigateToRegister()">Register</button>
          </ng-template>
        </div>
      </div>
    </header>
